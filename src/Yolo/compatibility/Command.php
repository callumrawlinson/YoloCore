 ...
 * Note: this file added for pmmp compatibility
 *
*/
...
abstract class Command extends \pocketmine\command\Command
{
    ...
    /** @var \pocketmine\command\CommandMap|null */
     ...
     *
     * @param \pocketmine\command\CommandMap $commandMap
     *
     * @return bool
     */
